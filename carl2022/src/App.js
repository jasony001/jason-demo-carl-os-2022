...
function App() {
  ...
  const dataCollectionList = [
    ...
    { collectionName: "luDlrOpStatusReasonList", keyColumnName: "DlrOpStatusReasonID"},
    { collectionName: "luDlrTypeList", keyColumnName: "DlrtypeID"},
    { collectionName: "luLegTypeList", keyColumnName: "LegTypeID"},
    { collectionName: "luPartyRltnBranchList", keyColumnName: "PartyRltnBranchID"},
    { collectionName: "luPartyRltnRoleList", keyColumnName: "PartyRltnRoleID"},
    { collectionName: "luRegStatusList", keyColumnName: "RegStatusID"},
    { collectionName: "luRegStatusReasonList", keyColumnName: "RegStatusReasonID"},
...
const loadAllLookupData = () => {
  ...
  if (!localStorage.getItem("lookupData")){
    dataAPIs.loadAllData(dataCollectionList)
    .then(d => {
      console.log(d)
    ...
    console.log('local', JSON.parse(localStorage.getItem("lookupData")))
  }
}
